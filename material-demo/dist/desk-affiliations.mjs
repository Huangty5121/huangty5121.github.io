...
export const organisations=[
 {id:'polyu',name:L('香港理工大学','The Hong Kong Polytechnic University'),mark:'polyu.png',study:['polyu'],records:['kteo','polyu-representative','polyu-representative-previous']},
 ...
 {id:'polysmart',name:L('PolySmart 课题组','PolySmart Group'),mark:'polysmart.png',records:['polysmart']},
 {id:'iluvatar',name:L('天数智芯','Iluvatar CoreX'),mark:'iluvatar.png',records:['qiyuan']},
 {id:'qiyuan',name:L('启元实验室','Qiyuan National Laboratory'),records:['qiyuan']},
 ...
 {id:'hksar',name:L('香港特区政府','HKSAR Government'),records:['gov-committee','gov-tutor']},
 {id:'hkcc',name:L('香港专上学院（HKCC）','Hong Kong Community College'),study:['hkcc'],records:['hkcc-representative']},
 {id:'cpce',name:L('理大专业及持续教育学院（CPCE）','PolyU CPCE'),records:['cpce-ambassador']},
];
