...
export const works = [
  {id:'heatwave', title:L('热浪风险研究','Cascading heatwave risks'), year:'2026', kind:'paper', context:'Physics and Chemistry of the Earth, Parts A/B/C',
    ...
    summary:L('研究极端高温如何通过生态与社会系统形成连锁健康风险。','Examines how extreme heat cascades through ecological and social systems into health risks.'),
  ...
  {id:'structrace',title:L('StrucTrace','StrucTrace'),year:'2026',kind:'paper',context:'npj Structural Biology',fullTitle:'StrucTrace: A universal Fourier watermark for traceable biomolecular structures',
    summary:L('利用傅里叶水印追踪生物分子结构的来源。','Uses a Fourier watermark to trace the provenance of biomolecular structures.'),
  ...
  {id:'crypto',title:L('Crypto-ncRNA','Crypto-ncRNA'),year:'2025–26',kind:'paper',context:'AI for Nucleic Acids (AI4NA) Workshop · International Conference on Learning Representations (ICLR 2025)',fullTitle:'Crypto-ncRNA: a bio-inspired post-quantum cryptographic primitive exploiting RNA folding complexity',
    authors:'Xu Wang, Yiquan Wang, Tin-Yeh Huang, Zhaorui Jiang, Kai Wei',
    summary:L('探索 RNA 折叠复杂度能否用于构造密码学原语。','Explores RNA folding complexity as a basis for a cryptographic primitive.'),
  ...
  {id:'olympic',title:L('奥运奖牌预测','Olympic medal prediction'),year:'2025',kind:'paper',context:'New In ML Affinity Event · International Conference on Machine Learning (ICML 2025)',fullTitle:'STGCN-LSTM for Olympic Medal Prediction: Dynamic Power Modeling and Causal Policy Optimization',
    authors:'Yiquan Wang, Jiaying Wang, Tin-Yeh Huang, Jingyi Yang, Zihao Xu',summary:L('用时空图网络与 LSTM 建模奥运奖牌预测。','Models Olympic medal prediction with a spatiotemporal graph network and LSTM.'),
  ...
  {id:'glm7',title:L('关于 GLM7 的评论','Comment on GLM7'),year:'2026',kind:'paper',context:'Advanced Science · Correspondence',fullTitle:'Comment on GLM7',summary:L('讨论 GLM7 研究中的方法与解释，并附作者回应。','Discusses methods and interpretation in the GLM7 study, with the authors’ reply.'),
  ...
  {id:'disease',title:L('疾病预测的局限','Limits of disease prediction'),year:'2025',kind:'paper',context:'Journal of Clinical Neuroscience · Letter',fullTitle:'AI for disease prediction: Performance insights and key limitations',summary:L('讨论 AI 疾病预测的性能评估与应用局限。','Discusses performance assessment and limits of AI disease prediction.'),
  ...
  {id:'oio',title:L('OIO','OIO'),year:'2025',kind:'paper',context:'IEEE International Conference on Bioinformatics and Biomedicine (BIBM 2025)',fullTitle:'Octopus inspired optimization (OIO): A hierarchical framework for navigating protein fitness landscapes',summary:L('提出用于蛋白质适应度景观搜索的分层优化框架。','Proposes a hierarchical optimization framework for protein fitness landscapes.'),body:L(['先保留 DOI 入口。还没有在这份 demo 中核对和收录最终全文。'],['The DOI is linked here. The final full text has not been checked and added to this demo.']),version:L('最终全文待核对','Final text to be checked'),links:[['IEEE / DOI','https://doi.org/10.1109/BIBM66473.2025.11356718']]},
