...
for(const lang of ['zh','tw','en']){
 ...
 const redirects=[['writing.html','about.html#cabinet-title'],['research.html','collection.html?filter=papers'],['projects.html','collection.html#practice'],['experience.html','about.html#experience'],['contact.html','about.html?contact=open'],...works.filter(w=>w.pdf||w.kind!=='paper').map(w=>[`work-${w.id}.html`,w.pdf?'read-'+w.id+'.html':'project-ninetoothed.html']),...experiences.map(e=>[`experience-${e.id}.html`,`about.html#record-${e.id}`])];
