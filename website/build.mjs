...
await writeFile(join(out,'tw/site.mjs'),zh2t(siteJs).replaceAll("document.body.dataset.lang==='zh'","document.body.dataset.lang!=='en'").replaceAll("'./assets/","'../assets/"));
...
for(const lang of ['zh','tw','en']){
 ...
 for(const [file,page] of specs){
  ...
  :`<a href="../${file}" class="language-link">中</a><a href="../tw/${file}" class="language-link">繁</a>`;
