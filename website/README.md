...
About uses OpenStreetMap tiles with WGS-84 institution pins. Within the factual records, the map comes first; city filters and organisation names follow it, and no record is expanded on entry. The three real album covers overlap on a pale shelf line beside the personal note and spread on hover, following the owner-supplied visual reference. Each cover links directly to Apple Music; narrow layouts also expose all three titles as text links. The personal reflection is prose, not a labelled set of emotions. The personal text uses the owner's September 2026 description of studying several disciplines and being a multifaceted person. The network visual is an editorial metaphor, not a literal map of five relationships. Work has no search or sort controls for its nine records; News shows source excerpts and links rather than site-update filler.
